 ...
 * @property toolRegistry The registry containing available tools
 * @property config The console UI configuration
 */
class ConsoleCommandHandler(
    private val logger: Logger,
    private val toolRegistry: ConsoleToolRegistry,
     ...
     * 
     * @return CommandResult.Output with formatted tools list
     */
    private fun handleTools(): CommandResult {
